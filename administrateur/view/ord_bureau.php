...
$requete="select N°serie,typee,Marque,Model,categorie,caractéristiques,date_acquisition,cout,fournisseur,image from materiel where typee='ordinateur' and categorie='bureau' ";

$statement= $connexion->query($requete);
$resultat=$statement->fetchAll();//contient toutes les donneés de la requéte select
echo"<div class='row mt'><div class='col-md-12'><div class='content-panel'>   <h3><i class='fa fa-angle-right'></i> Ordinateurs du Bureau </h3><table border=1 class='table caption-top'  style='background-color:white;width:1000px;'> <tr style='background-color:rgb(207, 230, 240);'>
