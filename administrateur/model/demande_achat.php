...
$requete="select cin	,Nom	,Num_tel,	produit	,marque  from demandeachat";

$statement= $connexion->query($requete);
$resultat=$statement->fetchAll();//contient toutes les donneés de la requéte select
echo"<div class='row mt'><div class='col-md-12'><div class='content-panel'>   <h3><i class='fa fa-angle-right'></i> Les demandes d'àchats </h3><table border=1 class='table caption-top'  style='background-color:white;width:1000px;'> <tr style='background-color:rgb(207, 230, 240);'>
...
{   
    echo"<tr>";
     echo " <td> ".$mt['cin']."</td>";
    echo" <td>". $mt['Nom']."</td>";
    echo "<td> ".$mt['Num_tel']."</td>";
    echo"<td>". $mt['produit']."</td>";
    echo"<td>". $mt['marque']."</td>";

    echo "<td><a class='btn btn-danger' href='supp_demande.php?cin=".$mt['cin']."'><i class='fa fa-trash-o'style='color:white;'></i></a></td>"; 
    echo "<td><a class='btn btn-success' href='repondre_msg.php?cin=".$mt['cin']."'><svg xmlns='http://www.w3.org/2000/svg' width='15' height='15' fill='currentColor' class='bi bi-envelope' viewBox='0 0 16 16'>
