...
<?php
    ...
    $requete="select id ,nomc, cin , Mesg  from reclamation";

    $statement= $connexion->query($requete);
    $resultat=$statement->fetchAll();//contient toutes les donneés de la requéte select
    echo"<div class='row mt'><div class='col-md-12'><div class='content-panel'>   <h3><i class='fa fa-angle-right'></i> Les Reclamations </h3><table border=1 class='table caption-top'  style='background-color:white;width:1000px;'> <tr style='background-color:rgb(207, 230, 240);'>
    ...
    {   
      ...
      echo "<td> ".$mt['cin']."</td>";
      echo"<td>". $mt['Mesg']."</td>";
      echo "<td><a class='btn btn-danger' href='supp_recl.php?id=".$mt['id']."'><i class='fa fa-trash-o'style='color:white;'></i></a></td>"; 
