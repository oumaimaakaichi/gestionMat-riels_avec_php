...
<div class="d">
  <br>
            <h2><i><b>Les Ordinateurs portables </b></i></h2> 
            <br>
            <br>
        </div><br>
<?php
      ...
      $requete="select N°serie,typee,Marque,Model,caractéristiques,date_acquisition,cout,image from materiel where typee='ordinateur' and categorie='portable'  ";
