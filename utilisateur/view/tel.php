...
<body class="bg-dark"><br>
    <div class="d">
      <br>
                <h2><i><b>Les Téléphones Portables </b></i></h2> 
                <br>
                <br>
            </div><br>
    <?php
        ...
        $requete="select N°serie,typee,Marque,Model,caractéristiques,date_acquisition,cout,image from materiel where typee='téléphone' ";
